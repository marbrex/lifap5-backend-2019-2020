...
# on configure le fichier ~/.pgpass avec le mot de passe saisi (ici <PASSWORD-LIFAP5-PSQL>)
 echo localhost:5432:lifap5:lifap5:<PASSWORD-LIFAP5-PSQL> > ~/.pgpass
 chmod 600  ~/.pgpass
...
select quiz_id, title, owner_id,
       question_id, question.sentence, weight,
...
> /!\ NPM Packages used in this package.json are outdated, for instance "pm2". Remove it and install a newer version...
